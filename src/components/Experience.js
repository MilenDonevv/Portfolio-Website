...
const experiences = [
  {
    ...
    description:
      "I am currently beyond excited to find my first position as a Frontend Developer and eager to immerse myself in a collaborative and supportive work environment, looking forward to leveraging my expertise to its fullest while continuously expanding my skill set. Armed with solid fundamentals in HTML, CSS, JavaScript, and contemporary frameworks such as React, I am passionate about engaging in pioneering projects and contribute to creating captivating user experience.",
  },
  {
